...
UPDATE_CHNL = os.environ.get("UPDATE_CHNL","Unknown_bande")
OWNER_USERNAME = os.environ.get("OWNER_USERNAME","unknown_bande")
SUPPORT_GRP = os.environ.get("SUPPORT_GRP","punjabiii_chat")
